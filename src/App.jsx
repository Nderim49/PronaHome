...
const STRINGS = {
  sq: {
    ...
    yearBuiltLabel: "Viti i ndërtimit", yearBuiltPlaceholder: "p.sh. 2015", landAreaStat: "Sipërfaqja e truallit",
  ...
  en: {
    ...
    yearBuiltLabel: "Year Built", yearBuiltPlaceholder: "e.g. 2015", landAreaStat: "Land Area",
...
function CountryTypeahead({ value, onChange, placeholder, countries }) {
  const { lang } = useLang();
  const nameOf = (c) => (lang === "de" ? (c.nameDe || c.name) : lang === "en" ? (c.nameEn || c.name) : c.name);
  const list = countries || WORLD_COUNTRIES;
  const selected = list.find((c) => c.code === value);
  const [query, setQuery] = useState(selected ? `${flagEmoji(selected.code)} ${nameOf(selected)} (${selected.dial})` : "");
  const [open, setOpen] = useState(false);

  useEffect(() => {
    const sel = list.find((c) => c.code === value);
    setQuery(sel ? `${flagEmoji(sel.code)} ${nameOf(sel)} (${sel.dial})` : "");
  }, [value, lang]);

  const filtered = useMemo(() => {
    const q = query.trim().toLowerCase();
    const base = !q || list.some((c) => `${flagEmoji(c.code)} ${nameOf(c)} (${c.dial})` === query)
      ? list
      : list.filter((c) => nameOf(c).toLowerCase().includes(q));
    return base.slice(0, 8);
  }, [query, lang]);

  const pick = (c) => {
    onChange(c.code);
    setQuery(`${flagEmoji(c.code)} ${nameOf(c)} (${c.dial})`);
    setOpen(false);
  };
      ...
      {open && filtered.length > 0 && (
        <div style={{
          ...
          {filtered.map((c) => (
            ...
            >
              {flagEmoji(c.code)} {nameOf(c)} <span style={{ color: "var(--ph-text-muted)" }}>({c.dial})</span>
            </button>
          ))}
        </div>
      )}
...
const WORLD_COUNTRIES = [
  { code: "XK", name: "Kosovë", nameDe: "Kosovo", nameEn: "Kosovo", dial: "+383" },
  { code: "AL", name: "Shqipëri", nameDe: "Albanien", nameEn: "Albania", dial: "+355" },
  { code: "ME", name: "Mal i Zi", nameDe: "Montenegro", nameEn: "Montenegro", dial: "+382" },
  { code: "MK", name: "Maqedonia e Veriut", nameDe: "Nordmazedonien", nameEn: "North Macedonia", dial: "+389" },
  { code: "AF", name: "Afganistan", nameDe: "Afghanistan", nameEn: "Afghanistan", dial: "+93" },
  { code: "ZA", name: "Afrika e Jugut", nameDe: "Südafrika", nameEn: "South Africa", dial: "+27" },
  { code: "DZ", name: "Algjeri", nameDe: "Algerien", nameEn: "Algeria", dial: "+213" },
  { code: "AD", name: "Andorra", nameDe: "Andorra", nameEn: "Andorra", dial: "+376" },
  { code: "AO", name: "Angola", nameDe: "Angola", nameEn: "Angola", dial: "+244" },
  { code: "AG", name: "Antigua dhe Barbuda", nameDe: "Antigua und Barbuda", nameEn: "Antigua and Barbuda", dial: "+1268" },
  { code: "SA", name: "Arabia Saudite", nameDe: "Saudi-Arabien", nameEn: "Saudi Arabia", dial: "+966" },
  { code: "AR", name: "Argjentinë", nameDe: "Argentinien", nameEn: "Argentina", dial: "+54" },
  { code: "AM", name: "Armeni", nameDe: "Armenien", nameEn: "Armenia", dial: "+374" },
  { code: "AU", name: "Australi", nameDe: "Australien", nameEn: "Australia", dial: "+61" },
  { code: "AT", name: "Austri", nameDe: "Österreich", nameEn: "Austria", dial: "+43" },
  { code: "AZ", name: "Azerbajxhan", nameDe: "Aserbaidschan", nameEn: "Azerbaijan", dial: "+994" },
  { code: "BS", name: "Bahamas", nameDe: "Bahamas", nameEn: "Bahamas", dial: "+1242" },
  { code: "BH", name: "Bahrein", nameDe: "Bahrain", nameEn: "Bahrain", dial: "+973" },
  { code: "BD", name: "Bangladesh", nameDe: "Bangladesch", nameEn: "Bangladesh", dial: "+880" },
  { code: "BB", name: "Barbados", nameDe: "Barbados", nameEn: "Barbados", dial: "+1246" },
  { code: "BE", name: "Belgjikë", nameDe: "Belgien", nameEn: "Belgium", dial: "+32" },
  { code: "BZ", name: "Belize", nameDe: "Belize", nameEn: "Belize", dial: "+501" },
  { code: "BJ", name: "Benin", nameDe: "Benin", nameEn: "Benin", dial: "+229" },
  { code: "BT", name: "Bhutan", nameDe: "Bhutan", nameEn: "Bhutan", dial: "+975" },
  { code: "BY", name: "Bjellorusi", nameDe: "Belarus", nameEn: "Belarus", dial: "+375" },
  { code: "BO", name: "Bolivi", nameDe: "Bolivien", nameEn: "Bolivia", dial: "+591" },
  { code: "BA", name: "Bosnjë dhe Hercegovinë", nameDe: "Bosnien und Herzegowina", nameEn: "Bosnia and Herzegovina", dial: "+387" },
  { code: "BW", name: "Botsvana", nameDe: "Botswana", nameEn: "Botswana", dial: "+267" },
  { code: "BR", name: "Brazil", nameDe: "Brasilien", nameEn: "Brazil", dial: "+55" },
  { code: "CI", name: "Bregu i Fildishtë", nameDe: "Elfenbeinküste", nameEn: "Ivory Coast", dial: "+225" },
  { code: "BN", name: "Brunei", nameDe: "Brunei", nameEn: "Brunei", dial: "+673" },
  { code: "BG", name: "Bullgari", nameDe: "Bulgarien", nameEn: "Bulgaria", dial: "+359" },
  { code: "BF", name: "Burkina Faso", nameDe: "Burkina Faso", nameEn: "Burkina Faso", dial: "+226" },
  { code: "BI", name: "Burundi", nameDe: "Burundi", nameEn: "Burundi", dial: "+257" },
  { code: "TD", name: "Çad", nameDe: "Tschad", nameEn: "Chad", dial: "+235" },
  { code: "DK", name: "Danimarkë", nameDe: "Dänemark", nameEn: "Denmark", dial: "+45" },
  { code: "DM", name: "Dominika", nameDe: "Dominica", nameEn: "Dominica", dial: "+1767" },
  { code: "EG", name: "Egjipt", nameDe: "Ägypten", nameEn: "Egypt", dial: "+20" },
  { code: "EC", name: "Ekuador", nameDe: "Ecuador", nameEn: "Ecuador", dial: "+593" },
  { code: "SV", name: "El Salvador", nameDe: "El Salvador", nameEn: "El Salvador", dial: "+503" },
  { code: "AE", name: "Emiratet e Bashkuara Arabe", nameDe: "Vereinigte Arabische Emirate", nameEn: "United Arab Emirates", dial: "+971" },
  { code: "ER", name: "Eritre", nameDe: "Eritrea", nameEn: "Eritrea", dial: "+291" },
  { code: "EE", name: "Estoni", nameDe: "Estland", nameEn: "Estonia", dial: "+372" },
  { code: "SZ", name: "Esvatini", nameDe: "Eswatini", nameEn: "Eswatini", dial: "+268" },
  { code: "ET", name: "Etiopi", nameDe: "Äthiopien", nameEn: "Ethiopia", dial: "+251" },
  { code: "PH", name: "Filipine", nameDe: "Philippinen", nameEn: "Philippines", dial: "+63" },
  { code: "FI", name: "Finlandë", nameDe: "Finnland", nameEn: "Finland", dial: "+358" },
  { code: "FJ", name: "Fixhi", nameDe: "Fidschi", nameEn: "Fiji", dial: "+679" },
  { code: "FR", name: "Francë", nameDe: "Frankreich", nameEn: "France", dial: "+33" },
  { code: "GA", name: "Gabon", nameDe: "Gabun", nameEn: "Gabon", dial: "+241" },
  { code: "GM", name: "Gambia", nameDe: "Gambia", nameEn: "Gambia", dial: "+220" },
  { code: "GH", name: "Gana", nameDe: "Ghana", nameEn: "Ghana", dial: "+233" },
  { code: "GE", name: "Gjeorgji", nameDe: "Georgien", nameEn: "Georgia", dial: "+995" },
  { code: "DE", name: "Gjermani", nameDe: "Deutschland", nameEn: "Germany", dial: "+49" },
  { code: "GD", name: "Grenada", nameDe: "Grenada", nameEn: "Grenada", dial: "+1473" },
  { code: "GR", name: "Greqi", nameDe: "Griechenland", nameEn: "Greece", dial: "+30" },
  { code: "GY", name: "Guajana", nameDe: "Guyana", nameEn: "Guyana", dial: "+592" },
  { code: "GT", name: "Guatemalë", nameDe: "Guatemala", nameEn: "Guatemala", dial: "+502" },
  { code: "GN", name: "Guine", nameDe: "Guinea", nameEn: "Guinea", dial: "+224" },
  { code: "GW", name: "Guine-Bisau", nameDe: "Guinea-Bissau", nameEn: "Guinea-Bissau", dial: "+245" },
  { code: "GQ", name: "Guinea Ekuatoriale", nameDe: "Äquatorialguinea", nameEn: "Equatorial Guinea", dial: "+240" },
  { code: "HT", name: "Haiti", nameDe: "Haiti", nameEn: "Haiti", dial: "+509" },
  { code: "NL", name: "Holandë", nameDe: "Niederlande", nameEn: "Netherlands", dial: "+31" },
  { code: "HN", name: "Honduras", nameDe: "Honduras", nameEn: "Honduras", dial: "+504" },
  { code: "HU", name: "Hungari", nameDe: "Ungarn", nameEn: "Hungary", dial: "+36" },
  { code: "IN", name: "Indi", nameDe: "Indien", nameEn: "India", dial: "+91" },
  { code: "ID", name: "Indonezi", nameDe: "Indonesien", nameEn: "Indonesia", dial: "+62" },
  { code: "IQ", name: "Irak", nameDe: "Irak", nameEn: "Iraq", dial: "+964" },
  { code: "IR", name: "Iran", nameDe: "Iran", nameEn: "Iran", dial: "+98" },
  { code: "IE", name: "Irlandë", nameDe: "Irland", nameEn: "Ireland", dial: "+353" },
  { code: "MH", name: "Ishujt Marshall", nameDe: "Marshallinseln", nameEn: "Marshall Islands", dial: "+692" },
  { code: "SB", name: "Ishujt Solomon", nameDe: "Salomonen", nameEn: "Solomon Islands", dial: "+677" },
  { code: "IS", name: "Islandë", nameDe: "Island", nameEn: "Iceland", dial: "+354" },
  { code: "IT", name: "Itali", nameDe: "Italien", nameEn: "Italy", dial: "+39" },
  { code: "IL", name: "Izrael", nameDe: "Israel", nameEn: "Israel", dial: "+972" },
  { code: "JP", name: "Japoni", nameDe: "Japan", nameEn: "Japan", dial: "+81" },
  { code: "YE", name: "Jemen", nameDe: "Jemen", nameEn: "Yemen", dial: "+967" },
  { code: "JO", name: "Jordani", nameDe: "Jordanien", nameEn: "Jordan", dial: "+962" },
  { code: "KH", name: "Kamboxhia", nameDe: "Kambodscha", nameEn: "Cambodia", dial: "+855" },
  { code: "CM", name: "Kamerun", nameDe: "Kamerun", nameEn: "Cameroon", dial: "+237" },
  { code: "CA", name: "Kanada", nameDe: "Kanada", nameEn: "Canada", dial: "+1" },
  { code: "QA", name: "Katar", nameDe: "Katar", nameEn: "Qatar", dial: "+974" },
  { code: "KZ", name: "Kazakistan", nameDe: "Kasachstan", nameEn: "Kazakhstan", dial: "+7" },
  { code: "KE", name: "Kenia", nameDe: "Kenia", nameEn: "Kenya", dial: "+254" },
  { code: "CV", name: "Kepi i Gjelbër", nameDe: "Kap Verde", nameEn: "Cabo Verde", dial: "+238" },
  { code: "CL", name: "Kili", nameDe: "Chile", nameEn: "Chile", dial: "+56" },
  { code: "CN", name: "Kinë", nameDe: "China", nameEn: "China", dial: "+86" },
  { code: "KG", name: "Kirgistan", nameDe: "Kirgisistan", nameEn: "Kyrgyzstan", dial: "+996" },
  { code: "KI", name: "Kiribati", nameDe: "Kiribati", nameEn: "Kiribati", dial: "+686" },
  { code: "CO", name: "Kolumbi", nameDe: "Kolumbien", nameEn: "Colombia", dial: "+57" },
  { code: "KM", name: "Komoret", nameDe: "Komoren", nameEn: "Comoros", dial: "+269" },
  { code: "CG", name: "Kongo", nameDe: "Kongo", nameEn: "Congo", dial: "+242" },
  { code: "CD", name: "Kongo (RD)", nameDe: "DR Kongo", nameEn: "DR Congo", dial: "+243" },
  { code: "KR", name: "Korea e Jugut", nameDe: "Südkorea", nameEn: "South Korea", dial: "+82" },
  { code: "KP", name: "Korea e Veriut", nameDe: "Nordkorea", nameEn: "North Korea", dial: "+850" },
  { code: "CR", name: "Kosta Rika", nameDe: "Costa Rica", nameEn: "Costa Rica", dial: "+506" },
  { code: "HR", name: "Kroaci", nameDe: "Kroatien", nameEn: "Croatia", dial: "+385" },
  { code: "CU", name: "Kubë", nameDe: "Kuba", nameEn: "Cuba", dial: "+53" },
  { code: "KW", name: "Kuvajt", nameDe: "Kuwait", nameEn: "Kuwait", dial: "+965" },
  { code: "LA", name: "Laos", nameDe: "Laos", nameEn: "Laos", dial: "+856" },
  { code: "LS", name: "Lesoto", nameDe: "Lesotho", nameEn: "Lesotho", dial: "+266" },
  { code: "LV", name: "Letoni", nameDe: "Lettland", nameEn: "Latvia", dial: "+371" },
  { code: "LB", name: "Liban", nameDe: "Libanon", nameEn: "Lebanon", dial: "+961" },
  { code: "LR", name: "Liberi", nameDe: "Liberia", nameEn: "Liberia", dial: "+231" },
  { code: "LY", name: "Libi", nameDe: "Libyen", nameEn: "Libya", dial: "+218" },
  { code: "LI", name: "Lihtenshtajn", nameDe: "Liechtenstein", nameEn: "Liechtenstein", dial: "+423" },
  { code: "LT", name: "Lituani", nameDe: "Litauen", nameEn: "Lithuania", dial: "+370" },
  { code: "LU", name: "Luksemburg", nameDe: "Luxemburg", nameEn: "Luxembourg", dial: "+352" },
  { code: "MG", name: "Madagaskar", nameDe: "Madagaskar", nameEn: "Madagascar", dial: "+261" },
  { code: "MY", name: "Malajzi", nameDe: "Malaysia", nameEn: "Malaysia", dial: "+60" },
  { code: "MW", name: "Malavi", nameDe: "Malawi", nameEn: "Malawi", dial: "+265" },
  { code: "MV", name: "Maldive", nameDe: "Malediven", nameEn: "Maldives", dial: "+960" },
  { code: "ML", name: "Mali", nameDe: "Mali", nameEn: "Mali", dial: "+223" },
  { code: "MT", name: "Maltë", nameDe: "Malta", nameEn: "Malta", dial: "+356" },
  { code: "MA", name: "Marok", nameDe: "Marokko", nameEn: "Morocco", dial: "+212" },
  { code: "MR", name: "Mauritani", nameDe: "Mauretanien", nameEn: "Mauritania", dial: "+222" },
  { code: "MU", name: "Mauritius", nameDe: "Mauritius", nameEn: "Mauritius", dial: "+230" },
  { code: "GB", name: "Mbretëria e Bashkuar", nameDe: "Vereinigtes Königreich", nameEn: "United Kingdom", dial: "+44" },
  { code: "MX", name: "Meksikë", nameDe: "Mexiko", nameEn: "Mexico", dial: "+52" },
  { code: "MM", name: "Mianmar", nameDe: "Myanmar", nameEn: "Myanmar", dial: "+95" },
  { code: "FM", name: "Mikronezia", nameDe: "Mikronesien", nameEn: "Micronesia", dial: "+691" },
  { code: "MD", name: "Moldavi", nameDe: "Moldau", nameEn: "Moldova", dial: "+373" },
  { code: "MC", name: "Monako", nameDe: "Monaco", nameEn: "Monaco", dial: "+377" },
  { code: "MN", name: "Mongoli", nameDe: "Mongolei", nameEn: "Mongolia", dial: "+976" },
  { code: "MZ", name: "Mozambik", nameDe: "Mosambik", nameEn: "Mozambique", dial: "+258" },
  { code: "NA", name: "Namibi", nameDe: "Namibia", nameEn: "Namibia", dial: "+264" },
  { code: "NR", name: "Nauru", nameDe: "Nauru", nameEn: "Nauru", dial: "+674" },
  { code: "NP", name: "Nepal", nameDe: "Nepal", nameEn: "Nepal", dial: "+977" },
  { code: "NE", name: "Niger", nameDe: "Niger", nameEn: "Niger", dial: "+227" },
  { code: "NG", name: "Nigeri", nameDe: "Nigeria", nameEn: "Nigeria", dial: "+234" },
  { code: "NI", name: "Nikaragua", nameDe: "Nicaragua", nameEn: "Nicaragua", dial: "+505" },
  { code: "NO", name: "Norvegji", nameDe: "Norwegen", nameEn: "Norway", dial: "+47" },
  { code: "OM", name: "Oman", nameDe: "Oman", nameEn: "Oman", dial: "+968" },
  { code: "PK", name: "Pakistan", nameDe: "Pakistan", nameEn: "Pakistan", dial: "+92" },
  { code: "PW", name: "Palau", nameDe: "Palau", nameEn: "Palau", dial: "+680" },
  { code: "PA", name: "Panama", nameDe: "Panama", nameEn: "Panama", dial: "+507" },
  { code: "PG", name: "Papua Guinea e Re", nameDe: "Papua-Neuguinea", nameEn: "Papua New Guinea", dial: "+675" },
  { code: "PY", name: "Paraguaj", nameDe: "Paraguay", nameEn: "Paraguay", dial: "+595" },
  { code: "PE", name: "Peru", nameDe: "Peru", nameEn: "Peru", dial: "+51" },
  { code: "PL", name: "Poloni", nameDe: "Polen", nameEn: "Poland", dial: "+48" },
  { code: "PT", name: "Portugali", nameDe: "Portugal", nameEn: "Portugal", dial: "+351" },
  { code: "CY", name: "Qipro", nameDe: "Zypern", nameEn: "Cyprus", dial: "+357" },
  { code: "DO", name: "Republika Dominikane", nameDe: "Dominikanische Republik", nameEn: "Dominican Republic", dial: "+1809" },
  { code: "CF", name: "Republika Afrikano-Qendrore", nameDe: "Zentralafrikanische Republik", nameEn: "Central African Republic", dial: "+236" },
  { code: "CZ", name: "Republika Çeke", nameDe: "Tschechien", nameEn: "Czech Republic", dial: "+420" },
  { code: "RW", name: "Ruandë", nameDe: "Ruanda", nameEn: "Rwanda", dial: "+250" },
  { code: "RO", name: "Rumani", nameDe: "Rumänien", nameEn: "Romania", dial: "+40" },
  { code: "RU", name: "Rusi", nameDe: "Russland", nameEn: "Russia", dial: "+7" },
  { code: "WS", name: "Samoa", nameDe: "Samoa", nameEn: "Samoa", dial: "+685" },
  { code: "SM", name: "San Marino", nameDe: "San Marino", nameEn: "San Marino", dial: "+378" },
  { code: "ST", name: "San Tome e Prinsipe", nameDe: "São Tomé und Príncipe", nameEn: "São Tomé and Príncipe", dial: "+239" },
  { code: "SC", name: "Seishele", nameDe: "Seychellen", nameEn: "Seychelles", dial: "+248" },
  { code: "SN", name: "Senegal", nameDe: "Senegal", nameEn: "Senegal", dial: "+221" },
  { code: "RS", name: "Serbi", nameDe: "Serbien", nameEn: "Serbia", dial: "+381" },
  { code: "US", name: "Shtetet e Bashkuara", nameDe: "Vereinigte Staaten", nameEn: "United States", dial: "+1" },
  { code: "KN", name: "Shën Kits e Nevis", nameDe: "St. Kitts und Nevis", nameEn: "Saint Kitts and Nevis", dial: "+1869" },
  { code: "LC", name: "Shën Lucia", nameDe: "St. Lucia", nameEn: "Saint Lucia", dial: "+1758" },
  { code: "VC", name: "Shën Vinsenti dhe Grenadinet", nameDe: "St. Vincent und die Grenadinen", nameEn: "Saint Vincent and the Grenadines", dial: "+1784" },
  { code: "SL", name: "Sierra Leone", nameDe: "Sierra Leone", nameEn: "Sierra Leone", dial: "+232" },
  { code: "SG", name: "Singapor", nameDe: "Singapur", nameEn: "Singapore", dial: "+65" },
  { code: "SY", name: "Siri", nameDe: "Syrien", nameEn: "Syria", dial: "+963" },
  { code: "SK", name: "Sllovaki", nameDe: "Slowakei", nameEn: "Slovakia", dial: "+421" },
  { code: "SI", name: "Slloveni", nameDe: "Slowenien", nameEn: "Slovenia", dial: "+386" },
  { code: "SO", name: "Somali", nameDe: "Somalia", nameEn: "Somalia", dial: "+252" },
  { code: "ES", name: "Spanjë", nameDe: "Spanien", nameEn: "Spain", dial: "+34" },
  { code: "LK", name: "Sri Lanka", nameDe: "Sri Lanka", nameEn: "Sri Lanka", dial: "+94" },
  { code: "SD", name: "Sudan", nameDe: "Sudan", nameEn: "Sudan", dial: "+249" },
  { code: "SS", name: "Sudani i Jugut", nameDe: "Südsudan", nameEn: "South Sudan", dial: "+211" },
  { code: "SE", name: "Suedi", nameDe: "Schweden", nameEn: "Sweden", dial: "+46" },
  { code: "SR", name: "Surinam", nameDe: "Suriname", nameEn: "Suriname", dial: "+597" },
  { code: "TH", name: "Tajlandë", nameDe: "Thailand", nameEn: "Thailand", dial: "+66" },
  { code: "TZ", name: "Tanzani", nameDe: "Tansania", nameEn: "Tanzania", dial: "+255" },
  { code: "TJ", name: "Taxhikistan", nameDe: "Tadschikistan", nameEn: "Tajikistan", dial: "+992" },
  { code: "TL", name: "Timori Lindor", nameDe: "Osttimor", nameEn: "Timor-Leste", dial: "+670" },
  { code: "TG", name: "Togo", nameDe: "Togo", nameEn: "Togo", dial: "+228" },
  { code: "TO", name: "Tonga", nameDe: "Tonga", nameEn: "Tonga", dial: "+676" },
  { code: "TT", name: "Trinidad e Tobago", nameDe: "Trinidad und Tobago", nameEn: "Trinidad and Tobago", dial: "+1868" },
  { code: "TN", name: "Tunizi", nameDe: "Tunesien", nameEn: "Tunisia", dial: "+216" },
  { code: "TM", name: "Turkmenistan", nameDe: "Turkmenistan", nameEn: "Turkmenistan", dial: "+993" },
  { code: "TR", name: "Turqi", nameDe: "Türkei", nameEn: "Turkey", dial: "+90" },
  { code: "TV", name: "Tuvalu", nameDe: "Tuvalu", nameEn: "Tuvalu", dial: "+688" },
  { code: "UG", name: "Ugandë", nameDe: "Uganda", nameEn: "Uganda", dial: "+256" },
  { code: "UA", name: "Ukrainë", nameDe: "Ukraine", nameEn: "Ukraine", dial: "+380" },
  { code: "UY", name: "Uruguaj", nameDe: "Uruguay", nameEn: "Uruguay", dial: "+598" },
  { code: "UZ", name: "Uzbekistan", nameDe: "Usbekistan", nameEn: "Uzbekistan", dial: "+998" },
  { code: "VU", name: "Vanuatu", nameDe: "Vanuatu", nameEn: "Vanuatu", dial: "+678" },
  { code: "VA", name: "Vatikan", nameDe: "Vatikanstadt", nameEn: "Vatican City", dial: "+379" },
  { code: "VE", name: "Venezuelë", nameDe: "Venezuela", nameEn: "Venezuela", dial: "+58" },
  { code: "VN", name: "Vietnam", nameDe: "Vietnam", nameEn: "Vietnam", dial: "+84" },
  { code: "JM", name: "Xhamajkë", nameDe: "Jamaika", nameEn: "Jamaica", dial: "+1876" },
  { code: "DJ", name: "Xhibuti", nameDe: "Dschibuti", nameEn: "Djibouti", dial: "+253" },
  { code: "ZM", name: "Zambi", nameDe: "Sambia", nameEn: "Zambia", dial: "+260" },
  { code: "NZ", name: "Zelanda e Re", nameDe: "Neuseeland", nameEn: "New Zealand", dial: "+64" },
  { code: "ZW", name: "Zimbabve", nameDe: "Simbabwe", nameEn: "Zimbabwe", dial: "+263" },
  { code: "CH", name: "Zvicër", nameDe: "Schweiz", nameEn: "Switzerland", dial: "+41" },
];
...
const CAT_ICON = {
  ...
  notar: Briefcase, financim: Wallet,
};
const CAT_GRADIENT = {
  ...
  notar: `linear-gradient(135deg, #1F3A3A 0%, #4A7A7A 140%)`,
  financim: `linear-gradient(135deg, #1E4620 0%, #4F8F52 140%)`,
};
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "var(--ph-bg)", display: "flex", flexDirection: "column", zIndex: 30 }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden", padding: "18px 18px 100px" }}>
        ...
        {(listing.landArea || listing.yearBuilt || listing.heatingType) && (
          <div style={{ display: "flex", gap: 10, marginBottom: 18, flexWrap: "wrap" }}>
            {listing.landArea && (
              <div style={{ flex: 1, background: "var(--ph-surface)", borderRadius: 12, padding: "10px 8px", textAlign: "center", border: "1px solid var(--ph-border)" }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: "var(--ph-text)" }}>{formatRangeValue(listing.landArea, listing.landAreaMax)} m²</div>
                <div style={{ fontSize: 10.5, color: "var(--ph-text-muted)" }}>{t.landAreaStat}</div>
              </div>
            )}
            {listing.yearBuilt && (
              <div style={{ flex: 1, background: "var(--ph-surface)", borderRadius: 12, padding: "10px 8px", textAlign: "center", border: "1px solid var(--ph-border)" }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: "var(--ph-text)" }}>{formatRangeValue(listing.yearBuilt, listing.yearBuiltMax)}</div>
...
function NewListingScreen({ onBack, onPublish, agencies, editingListing, profile }) {
  ...
  const [form, setForm] = useState(() => {
    if (editingListing) {
      ...
      return {
        ...
        yearBuiltMax: editingListing.yearBuiltMax != null ? String(editingListing.yearBuiltMax) : "",
        landArea: editingListing.landArea != null ? String(editingListing.landArea) : "", landAreaMax: editingListing.landAreaMax != null ? String(editingListing.landAreaMax) : "",
  ...
  const submit = async () => {
    ...
    const newListing = isBusinessCard ? {
      ...
      yearBuiltMax: form.yearBuiltMax ? Number(form.yearBuiltMax) : null,
      landArea: form.landArea ? Number(form.landArea) : null, landAreaMax: form.landAreaMax ? Number(form.landAreaMax) : null,
          ...
          <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 12 }}>
            {isAgencyAccount && form.cat && (
              <button
                ...
                style={{ display: "flex", alignItems: "center", gap: 5, alignSelf: "flex-start", border: "none", background: "none", color: "var(--ph-accent)", fontSize: 13, fontWeight: 600, cursor: "pointer", padding: 0 }}
              >
                <ChevronLeft size={15} /> {t.changeCategoryLabel}
              </button>
            )}
            ...
            {isAgencyAccount && (!form.cat || BUSINESS_CARD_CATS.includes(form.cat)) && (
              <div>
                ...
                <select
                  style={inputStyle}
                  value={
                    form.cat === "kuzhina" ? "mobilje"
                    : form.cat === "statike" ? "arkitekt"
                    : BUSINESS_CARD_CATS.includes(form.cat) ? form.cat : ""
                  }
                  onChange={(e) => { if (e.target.value) setForm((f) => ({ ...f, cat: e.target.value })); }}
                >
                  {!BUSINESS_CARD_CATS.includes(form.cat) && <option value="">{t.chooseOption}</option>}
                  {VISITENKARTE_OPTIONS.map((o) => (
...
function AgenciesScreen({ onBack, onOpenGroup }) {
  ...
  const GROUPS = [
    ...
    { id: "notary", label: t.providerGroupNotary, icon: Briefcase, gradient: "linear-gradient(135deg, #1F3A3A 0%, #4A7A7A 140%)" },
    { id: "financing", label: t.providerGroupFinancing, icon: Wallet, gradient: "linear-gradient(135deg, #1E4620 0%, #4F8F52 140%)" },
  ];
...
const PROVIDER_GROUP_META = {
  ...
  notary: { icon: Briefcase, gradient: "linear-gradient(135deg, #1F3A3A 0%, #4A7A7A 140%)" },
  financing: { icon: Wallet, gradient: "linear-gradient(135deg, #1E4620 0%, #4F8F52 140%)" },
};
